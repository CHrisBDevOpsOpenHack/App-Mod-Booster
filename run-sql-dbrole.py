#!/usr/bin/env python3
"""
Grant managed identity database access to the Northwind database.
Runs script.sql which creates a database user for the managed identity
and grants db_datareader, db_datawriter, and EXECUTE permissions.
"""
import os
import pyodbc
import struct
...
# Database connection settings - update these to match your deployed resources
...
def execute_sql_script(server, database, script_file):
    ...
    try:
        ...
        # Split script into individual statements (by GO or statement termination)
        statements = []
        current_statement = []
